...
<head>
    ...
    <link href="functions/fkbooking.js" rel="stylesheet">
<style>
* {
  ...
  <div class="row">
      ...
      <div class="column" style="float: left;background-color:#fff;padding:50px">
       <h1>FK BOOKING</h1>
        ...
        <button class="button" style="vertical-align:middle" onclick="register()"><span>Register </span></button>
      </div>
  <div style="float: right;">
  <h3 style="color: white;">Welcome</h3>
  <p style="color: white;">For Booking Facilities of Faculty for students and lecturers.</p>
...
if (isset($_POST['username'])){
    ...
    $passwusernameord = stripslashes($_REQUEST['password']);
...
?>
  ...
  <br>
  <span style="color: white;">Forgot Password ?</span><a href="forgotpassword.php">Click Here</a>
